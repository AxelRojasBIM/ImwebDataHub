import {
  ...
  MapPin, Boxes, Target, Calendar, Factory, Users, ClipboardCheck, FileText, Cog, ShoppingCart, Activity, ClipboardList, Waypoints,
} from 'lucide-react'
...
const nav = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/fr-planta-cedis-ajustado', label: 'FR Planta/Cedis Ajustado', icon: ClipboardList },
    ]
  },
  {
