      ...
      <div className="content">
        ...
        {!file && !saveResult && (
          <div
            ...
            style={{ border: '2px dashed #a5b4fc', borderRadius: 12, padding: '32px 20px', textAlign: 'center', cursor: 'pointer', background: '#f0f4ff', marginBottom: 20, transition: 'background 0.15s' }}
          >
                ...
                <tr key={b.batchId}>
                  ...
                  <td style={{ textAlign: 'right' }}>
                    <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
                      ...
                      <button className="btn" style={{ fontSize: 12, padding: '4px 12px', color: '#6366f1', borderColor: '#a5b4fc', background: '#eef2ff', fontWeight: 600 }} onClick={() => handleDownloadBatch(b)}>↓ CSV</button>
