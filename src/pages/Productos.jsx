...
export default function Productos() {
  ...
  useEffect(() => {
    fetch(`${API}/api/remisiones/productos`)
  ...
  return (
    <>
      <div className="topbar">
        <div>
          <div className="topbar-title">Productos CEQ</div>
          <div className="topbar-sub">{rows.length.toLocaleString()} registros · tabla RemisionesProductosCEQ</div>
        </div>
      ...
      <div className="content">
        ...
        <div className="filter-bar">
          <input placeholder="Buscar en productos..." value={search} onChange={e => setSearch(e.target.value)} />
        ...
        {loading ? (
          ...
          <div className="empty">Sin datos. La extensión CEQ aún no ha guardado productos.</div>
        ) : (
