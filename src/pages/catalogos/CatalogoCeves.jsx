  ...
  return (
    <span
      ...
      style={{
        ...
        background: row.turno_laboral ? '#f5f3ff' : '#f3f4f6',
        border: `1px solid ${row.turno_laboral ? '#c4b5fd' : '#e5e7eb'}`,
  ...
  if (editing) {
    return (
      <input
        ...
        style={{ width: '100%', padding: '4px 7px', borderRadius: 6, border: '1px solid #c4b5fd', fontSize: 13, background: '#fff' }}
      />
    )
  }
  return (
