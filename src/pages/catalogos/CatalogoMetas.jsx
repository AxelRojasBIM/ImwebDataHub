...
function TabConsolidado() {
  ...
  return (
    <div>
      {/* Botón ejecutar */}
      <div style={{ background:'#f0f4ff', border:'1px solid #d1d5db', borderRadius:12, padding:'14px 18px',
      ...
      {meta && (
        <div style={{ display:'flex', gap:12, marginBottom:14, flexWrap:'wrap' }}>
          {[
            ...
            { label:'De Hub Pedidos',  val: Number(meta.hub).toLocaleString(), color:'#475569' },
                ...
                <tr key={i}>
                  ...
                  <td>
                    <span style={{
                      ...
                      background: r.sistemaOrigen==='HubPedidos' ? '#f3f4f6' : '#ecfdf5',
                      color:      r.sistemaOrigen==='HubPedidos' ? '#475569' : '#065f46',
