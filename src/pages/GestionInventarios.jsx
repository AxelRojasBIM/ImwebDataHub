...
function ExtractoInventarioCard() {
  ...
  async function handleExportar() {
    ...
    try {
      ...
      const header = ['Origen', 'Fecha', 'CeVe', 'Nombre CeVe', 'Región', 'Organización', 'Item', 'Descripción', 'Marca', 'Categoría', 'Piezas por Empaque', 'Precio', 'Cantidad Total']
      const body = rows.map(r => [r.origen, r.fechaCaptura, r.ceveNombre, r.nombreCeve, r.region, r.organizacion, r.skuCodigo, r.productFullDesc, r.brandName, r.categoryName, r.pack1Size, r.piecePrice, r.cantidadTotal])
